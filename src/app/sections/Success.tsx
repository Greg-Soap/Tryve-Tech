...
export default function Success() {
  ...
  return (
    <section className="container flex scroll-m-20 flex-col items-start justify-start gap-8  bg-secondary max-md:px-5 max-md:py-6 md:px-10 md:py-12">
      {Feature.map((item, index) => (
        <div key={index} className="w-full">
          ...
          <div className="progress-bar w-full rounded-[22px] md:w-1/2">
            <div
              className="progress-bar-fill flex items-center bg-primary p-3"
